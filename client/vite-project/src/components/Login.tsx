...
const Login = () => {
  ...
  const submitHandler  = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (isLogin) {
      ...
      try {
        //toast.success("Please wait while we are logging you in...");
  ...
  return (
    <div className='w-screen h-screen flex items-center justify-center'>
      <div className='flex items-center justify-evenly w-[80%]'>
        ...
        <div className='w-[50%]'>
          <div className='my-5'>
          <h1 className=' font-bold text-5xl font-FacultyGlyphic'>Welcome to Vertx Creator Platform</h1>
          </div>
          ...
          <Link to="/AdminLogin">Are You an Admin?<span className='text-blue-600'>Click here to login as an Admin</span></Link>
